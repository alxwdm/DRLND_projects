# Different versions of replay buffer for experience replay:
# - DequeReplayBuffer is used for random sampling
# - PrioritizedReplayBuffer is an OpenAI implementation of PER
#   (needs HelperReplayBuffer as super class)
...
class PrioritizedReplayBuffer(HelperReplayBuffer):
    ...
    def sample(self, batch_size, beta):
        ...
        dones = torch.from_numpy(dones.astype(np.uint8)).unsqueeze(1).float().to(device)
